...
PUPPETDB_HOST = 'master.forwards.hostnetbv.nl'
PUPPETDB_PORT = 8081
PUPPETDB_PROTO = 'https'
PUPPETDB_SSL_VERIFY = '/etc/httpd/ssl/certs/ca.pem'
PUPPETDB_KEY = '/etc/httpd/ssl/private/master.forwards.hostnetbv.nl.pem'
PUPPETDB_CERT = '/etc/httpd/ssl/certs/master.forwards.hostnetbv.nl.pem'
PUPPETDB_TIMEOUT = 20
